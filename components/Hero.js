...
export default function Hero() {
  return (
    <>
      ...
      <div
        id="scroll"
        className="selection:bg-009999 selection:text-white sm:pb-12 pb-12 sm:h-fit h-screen bg-white"
      >
        <div className="grid grid-cols-2 sm:grid sm:grid-cols-1">
          <div className="pl-12">
            ...
            <p className="text-black text-left text-xl text-justify sm:text-lg sm:pt-5 pb-12 pt-12  pr-24 pr-5">
              <b>Ressources</b> : améliorer votre résilience face à
              l&apos;augmentation des coûts et des difficultés d&apos;accès à
              l&apos;énergie et aux matières premières.
              <br></br>
              <b>Réglementation</b> : anticiper et respecter l&apos;évolution et
              le durcissement de la réglementation.
              <br></br>
              <b>Marque</b> : soigner votre image de marque et votre marque
              employeur : répondre aux nouvelles exigences des clients et des
              candidats.
              <br></br>
              <b>Concurrence</b> : Différenciez-vous de la concurrence en
              opérant les changements garantissant la pérennité économique de
              l&apos;entreprise dans un monde qui se réchauffe.
              <br></br>
              ...
              construction d&apos;une économie et d&apos;une société atténuée et
              adaptée au défi colossal qui se présente.
            </p>{" "}
        ...
        <div className="grid grid-cols-2 sm:grid sm:grid-cols-1">
          ...
          <div className="sm:pl-12 sm:pt-12 laptop:m-auto laptop:mr-48">
            ...
            <p className="text-black text-left text-xl sm:text-lg sm:pt-5 pb-12 pt-12  pr-24 pr-5">
              Animée par une farouche ambition de participer à la création d&apos;une
              économie et d&apos;une société désirables, Un&Demi porte haut et fort
              ses valeurs d&apos;engagement, de pédagogie et d&apos;enthousiasme. <br></br><br></br>
              Chaque
              jour, Un&Demi est pleinement investit dans sa mission :
              ...
              +1.5°C au dessus des niveaux pré-industriels.<br></br><br></br> Ingénieur de
              formation et après 6 années d&apos;activités dans le secteur on ne peut
              plus carboné de la chimie, nous apportons aux organisations
              pédagogie et expertise énergie climat. Le but : vous accompagner
              vers l&apos;action et ainsi vous doter d&apos;une activité résiliente et
              adaptée aux bouleversements à venir.
            </p>{" "}
            <button className="bg-009999 border rounded-md p-2">
