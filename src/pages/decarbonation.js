        ...
        <div className="bg-white bg-cover h-full">
          ...
          <p className="text-black mx-12 pt-2 text-2xl">
            ...
            <p className="text-black  ml-2 pt-2 text-2xl">
              ...
              pétrole se renouvelle naturellement, grâce à la décomposition du
              ...
              puis augmenter de façon plus ou moins importante en fonction de
              ...
              décroît alors jusqu&apos;à épuisement des stocks. <br></br>
