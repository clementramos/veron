    ...
    <>
      ...
      <div className="bg-white bg-cover h-full">
        ...
        <p className="text-black  ml-12 pt-2 text-2xl">
          ...
          industrielles ou tertiaires, du patrimoine et des services d&apos;une
          collectivité territoriale, de l&apos;ensemble des activités d&apos;un
          territoire. En l&apos;utilisant de manière complète et appropriée,
          chacun pourra limiter sa contribution au changement climatique, et
          diminuera par la même occasion sa dépendance économique aux énergies
