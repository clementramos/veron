        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid sm:grid-cols-1">
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              millions d&apos;âmes à 1 milliard en 2800 ans (+ 900 millions). Ce
              phénomène est la conséquence directe de la révolution industrielle
              débuté en 1776 lors de l&apos;invention de la machine à vapeur par
              James Watt. La machine à vapeur fonctionne au charbon.
            </p>
            <Image
            ...
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              façon à partir des années 1850. Elle est composée aujourd&#39;hui
              à 80% d&apos;énergie fossile issue de matières premières
              non-renouvelables à l&apos;échelle des temps humains. Le pétrole,
              le charbon et le gaz. Ces derniers émettent du dioxyde de carbone
            ...
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              PIB par personne a été multiplié par plus de 14 entre 1820 et 2018
              (en à peine moins de 200 ans).
            </p>
            <Image
            ...
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              d&apos;énergie. « Donnez-moi le PIB mondial sur une année donnée,
            ...
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              an en 2022. Cela représente une multiplication des émissions par
              plus de 15 fois celles de l&apos;année 1850.
            </p>
            <Image
              className="pt-5 pb-12 sm:mx-auto"
            ...
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              mécaniquement une augmentation exponentielle de la concentration
              atmosphérique en CO 2 . Après 10 000 ans de stabilité parfaite, on
              observe une véritable explosion de cette concentration. Le dioxyde
              de carbone est un oxyde, c&apos;est une molécule chimiquement
              stable. Plusieurs milliers d&apos;années sont nécessaires pour que
              cette molécule disparaisse intégralement de l&apos;atmosphère
              après arrêt des émissions.
            </p>
            <p className="text-black text-justify pb-12 pt-20 text-2xl sm:text-lg">
              ...
              augmente. Après une période de stabilité climatique de plus de 10
              000 ans, qui nous a notamment permis la sédentarisation puis
              l&apos;agriculture et l&apos;élevage, la température moyenne
              globale de la terre augmente considérablement sur une période de
              temps très courte (150 ans). Nous évaluons aujourd&apos;hui à +1.2
              °C par rapport à l&apos;ère préindustrielle (1850-1900)
